...
function HistoryInspection1Monthly() {
    ...
    const handleDeleteUser = async (e: { preventDefault: () => void; }) => {
        ...
        try {
          ...
          const response = await fetch(`${domainApi}/api/v1/1monthly-inspections/${infoDeleteData.id}`, {
            method: 'DELETE',
            headers: {
            ...
            try {
              ...
              if (aparResponse.ok) {
                ...
                setAparData({
                  ...
                  last_1montly_check_time: aparData.data.last_1montly_check_time,
              ...
              const inspectionResponse = await fetch(`${domainApi}/api/v1/1monthly-inspections?id_apar=${id}`, {
                headers: {
                  Authorization: `Bearer ${token}`,
                },
              });
                                        ...
                                        <tr>
                                            ...
                                            <td className="col-5 col-md-10">
                                                    ...
                                                    differenceInMinutes(row.check_time) < 30 ? (
                                                        <Link to={`/history-1-monthly/edit/${row.id}`}>
  ...
  return (
    ...
    >
        ...
        <Card.Title> Riwayat Pemeriksaan 1 Bulanan  </Card.Title>
...
export default HistoryInspection1Monthly;