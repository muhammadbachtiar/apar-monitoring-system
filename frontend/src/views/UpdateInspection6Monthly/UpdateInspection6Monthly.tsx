...
function UpdateInspection6Monthly() {
    ...
    const handleUpdateInspection = async (data: FieldValues) => {
        ...
        try {
          ...
          const response = await fetch(`${domainApi}/api/v1/6monthly-inspections/${id}`, {
            method: 'PUT',
            headers: {
          ...
          if (response.ok) {
            ...
            navigate(`/history-6-monthly/${getValues('id_apar')}`);
          } else {
            const data = await response.json()
            setMessage(data.message)
            setShow(true)
          ...
          {loading ?
              ...
              <>
                <Breadcrumb>
                  ...
                  <Breadcrumb.Item linkAs={Link} linkProps={{ to: `/history-6-monthly/${getValues('id_apar')}` }}>Riwayat</Breadcrumb.Item>
                ...
                <div className="row my-3 align-items-center">
                    <div className="col">
                        ...
                        <Form className='shadow p-3 mb-2 bg-body-tertiary rounded' onSubmit={handleSubmit((data) => {handleUpdateInspection(data)})}>
                            ...
                            <Link to={`/history-6-monthly/${getValues('id_apar')}`}><Button className='btn-secondary'>Kembali</Button></Link>
...
export default UpdateInspection6Monthly;